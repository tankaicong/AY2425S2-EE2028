...
OBJS += \
./Src/asm_func.o \
./Src/asm_func_ultra.o \
./Src/main.o \
./Src/sysmem.o 

S_DEPS += \
./Src/asm_func.d \
./Src/asm_func_ultra.d 
...
clean-Src:
	-$(RM) ./Src/asm_func.d ./Src/asm_func.o ./Src/asm_func_ultra.d ./Src/asm_func_ultra.o ./Src/main.cyclo ./Src/main.d ./Src/main.o ./Src/main.su ./Src/sysmem.cyclo ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
